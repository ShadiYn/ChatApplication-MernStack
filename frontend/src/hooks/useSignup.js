...
const { firstName, lastName, userName, password, confirmPassword, gender } = inputs;

const succes = handleInputErrors({ firstName, lastName, userName, password, confirmPassword, gender });
if (!succes) return;
